...
5. `ai-project-assist/languages/*.md`
6. `.github/skills/*.md`
...
- Use `ai-project-assist/tech-stack.md` and repo files before assuming a language, framework, package manager, or test runner.
