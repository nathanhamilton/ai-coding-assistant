...
- load and maintain project files in `ai-project-assist/projects/`
...
- `ai-project-assist/project-init-guide.md`
- `ai-project-assist/projects/_index.md`
- `ai-project-assist/projects/_knowledge-base.md`
...
3. read `ai-project-assist/projects/_index.md`
...
2. create the project file from `ai-project-assist/projects/TEMPLATE.md`
3. update `_index.md`
...
When a project file grows too large, move older sessions into `ai-project-assist/projects/archive/sessions/` and keep recent activity in the main file.
