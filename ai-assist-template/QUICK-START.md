...
|----------|------------|-----------------|
| 🔴 Must | `ai-project-assist/base-context.md` | Real repo identity, purpose, team, workflow |
| 🔴 Must | `ai-project-assist/tech-stack.md` | Detected stack, versions, dependencies |
| 🔴 Must | `ai-project-assist/architecture.md` | Actual architecture and boundaries |
...
| 🟡 Should | `ai-project-assist/languages/*.md` | Guides for detected primary language(s) |
