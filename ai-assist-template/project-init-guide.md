...
6. create the project file from `ai-project-assist/projects/TEMPLATE.md`
7. update `ai-project-assist/projects/_index.md`
...
Patterns worth preserving should be added to `ai-project-assist/projects/_knowledge-base.md` with:
- the problem
- the solution
- trade-offs
- source project
