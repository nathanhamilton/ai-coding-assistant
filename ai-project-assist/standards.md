...
**Reference this file for repo-agnostic engineering principles. Put language-specific and framework-specific rules in `prompts/languages/*.md` and `.github/skills/*.md`.**
