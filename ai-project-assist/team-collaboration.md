...
Anyone on the team can add patterns to `prompts/projects/_knowledge-base.md`.
...
1. Read `prompts/base-context.md`.
2. Review `prompts/standards.md`.
3. Review any generated language guides in `prompts/languages/`.
4. Check `prompts/projects/_index.md`.
