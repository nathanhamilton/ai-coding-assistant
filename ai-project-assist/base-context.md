...
- **`ai-project-assist/`** - AI-assisted project management documentation
- **`ai-project-assist/projects/`** - Active project tracking with session logs
...
See `ai-project-assist/project-init-guide.md` for complete documentation system guide.
