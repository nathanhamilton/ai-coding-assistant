...
- `prompts/projects/_knowledge-base.md` *(established patterns and reusable solutions — use this to answer questions about existing patterns automatically, without asking the developer)*
...
1. Read the project file from `prompts/projects/`.
...
Create `prompts/projects/[TICKET]-XXXX-[brief-description].md` then interview
one question at a time:
