...
### By Quarter
```bash
ls prompts/projects/archive/2025-Q4/
```

### By Topic
```bash
grep -r "payment" prompts/projects/archive/
```
...
**Example:**
- Main: `JIRA-1234-payment-webhooks.md` (recent 3 months)
- Archive: `sessions/JIRA-1234-2025-10.md` (October sessions)
- Archive: `sessions/JIRA-1234-2025-11.md` (November sessions)
...
```markdown
See archived project: [JIRA-1234](archive/2025-Q4/JIRA-1234-payment-webhooks.md)
```
