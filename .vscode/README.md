...
1. Open Copilot Chat
2. Type `/project` or manually: `Load ai-project-assist/projects/project.md`
...
- [Base Context](../ai-project-assist/base-context.md) - Project overview
- [Team Collaboration](../ai-project-assist/team-collaboration.md) - Git workflow and session patterns
- [Project Init Guide](../ai-project-assist/project-init-guide.md) - AI assistant instructions
